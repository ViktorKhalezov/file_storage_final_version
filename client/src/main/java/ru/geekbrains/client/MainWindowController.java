...
import ru.geekbrains.common.ChangeDirectoryMessage;
import ru.geekbrains.common.CheckStatusMessage;
import ru.geekbrains.common.DeleteFileMessage;
...
public class MainWindowController implements Initializable {
    ...
    public void uploadButton(ActionEvent actionEvent) {
        try {
            root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/uploadFileWindow.fxml"));
    ...
    public void downloadButton(ActionEvent actionEvent) {
        ...
        if(item != null) {
            ...
            if (status.equals("isFile")) {
                ...
                try {
                    root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/directoryForDownloadWindow.fxml"));
                    stage = AppStarter.getPrimaryStage();
                    scene = new Scene(root);
                    stage.setScene(scene);
                } catch (IOException e) {
                ...
                try {
                    root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/isNotFileWindow.fxml"));
                    stage = AppStarter.getPrimaryStage();
                    scene = new Scene(root);
                    stage.setScene(scene);
                } catch (IOException e) {
    ...
    public void directoryDownButton(ActionEvent actionEvent) {
        ...
        if(item != null) {
            ...
            if (status.equals("isDirectory")) {
                ...
                try {
                    root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/isNotDirectoryWindow.fxml"));
                    stage = AppStarter.getPrimaryStage();
                    scene = new Scene(root);
                    stage.setScene(scene);
                } catch (IOException e) {
    ...
    public void renameFileButton(ActionEvent actionEvent) {
        ...
        if(fileForRename != null) {
            ...
            try {
                root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/newObjectNameWindow.fxml"));
                stage = AppStarter.getPrimaryStage();
                scene = new Scene(root);
                stage.setScene(scene);
            } catch (IOException e) {
    ...
    public void deleteFileButton(ActionEvent actionEvent) {
        ...
        if(clientNet.isOperationConfirmed() == true) {
            ...
            try {
                root = FXMLLoader.load(getClass().getResource("/ru/geekbrains/client/deleteFileErrorWindow.fxml"));
                stage = AppStarter.getPrimaryStage();
                scene = new Scene(root);
                stage.setScene(scene);
            } catch (IOException e) {
    ...
    public void exitButton(ActionEvent actionEvent) {
        clientNet.close();
        AppStarter.getPrimaryStage().close();
    }
